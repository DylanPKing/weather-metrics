...
class TestPostSensorData:
    ...
    def test_post_with_all_fields_returns_200(self, client, test_sensor):
    ...
    def test_post_returns_auto_generated_id(self, client, test_sensor):
    ...
    def test_post_returns_timestamp(self, client, test_sensor):
    ...
    def test_post_defaults_timestamp_to_utc(self, client, test_sensor):
    ...
    def test_post_with_custom_timestamp(self, client, test_sensor):
    ...
    def test_post_with_partial_optional_fields(self, client, test_sensor):
    ...
    def test_post_with_decimal_precision(self, client, test_sensor):
